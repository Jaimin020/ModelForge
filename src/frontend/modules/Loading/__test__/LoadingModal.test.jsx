...
describe('LoadingOverlay Component', () => {
  ...
  it('renders both named and default exports correctly', () => {
    const { getByText } = render(
      <LoadingOverlay isVisible={true} message="Test1" />,
    );
  ...
  it('handles very long message', () => {
    const longMessage =
      'This is a very long loading message that might span multiple lines and test how the component handles lengthy text content';
    const { getByText } = render(
