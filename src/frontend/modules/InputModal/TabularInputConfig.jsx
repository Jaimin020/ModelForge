...
export const TabularInputConfig = ({onSaveReady, selectedNode}) => {
    ...
    const handleSave = () => {
        const selectedFeatureNames = Array.from(selectedFeatures).map(index => columns[index]);
        const selectedPredictorName = selectedPredictor !== null ? columns[selectedPredictor] : null;
